...
public class ShopRecordService {
     ...
     */
    public ShopRecord createShopRecord(int userId, int goodId, int number, double cost, int wareHouseId, String addressId) {
        ShopRecord shopRecord = new ShopRecord(userId, goodId, number, cost, wareHouseId, addressId);
